...
object RH205Consts {
  ...
  internal const val CMD_DATA_LIST = 0x02.toByte() // 数据列表
  internal const val CMD_DATA_INFO_LIST = 0x03.toByte() // 数据信息
  internal const val CMD_DATA_DETAIL = 0x04.toByte() // 采样数据波形
